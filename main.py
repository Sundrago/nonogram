...
#WRITE txt files (IMPORT var 'task' FROM : https://www.puzzle-nonograms.com)
task = '3.1.3/3.1/6.1.1/1.3/2.3.2.3/4.3.3.3/4.6.3/5.3/6.5/4.1.1.3/1.3.3.2/1.5.3.1/3.3/7.3/5.4/7.1.1.6/5.11/1.3.5.3/10.3/1.8.3.1/2.3.8.1/2.3.5/2.2.6/2.6/1.7/5.1.1.1.2/3.3.3.1.1.2/1.8.4/1.1.6.5/1.1.6.4/1.1.5.5/1.2.4/1.3.1.1/1.2/2.3.4.3/6.9/6.9/1.2.7/3.1/4.1'
tasks = task.split('/')
...
for i in range(int(len(tasks)/2), len(tasks)):
    file.write(str(tasks[i]) + '\n')
file.close
